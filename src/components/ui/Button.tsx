...
export const Button = ({ color = 'main', className, children, animated = false, ...props }: ButtonProps) => {
    ...
    const colorStyles = {
        main: 'bg-primary/80 text-white hover:bg-primary/90 border-b-dark/20',
        secondary: 'bg-secondary/80 text-white hover:bg-secondary/90 border-b-4 border-b-secdark/70',
        black: 'bg-white/10 text-white hover:bg-black/90 border-b-4 border-b-black/70',
    };
