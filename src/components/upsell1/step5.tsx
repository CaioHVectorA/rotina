...
const INDEX = 2; // For upsell, /assets/upsell/3.webp

export default function UpsellStep5({ nextStep, addCurrency, step = 5, currency = 46738 }: { nextStep: () => void; addCurrency: (amount: number) => void; step?: number; currency?: number; }) {
    return (
