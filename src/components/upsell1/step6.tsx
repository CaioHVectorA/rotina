...
const plans: PlanData[] = [
    {
        ...
        price: "R$ 97,00",
        vagas: 9,
        href: "https://checkout.perfectpay.com.br/pay/PPU38CQ1PT1?upsell=true",
    ...
    },
    {
        ...
        price: "R$ 57,00",
        vagas: 24,
        href: "https://checkout.perfectpay.com.br/pay/PPU38CQ1PSU?upsell=true",
        icon: <span className="ml-1">🥇</span>,
        nextId: "#diamond",
        id: "gold",
    },
    {
        ...
        vagas: 1,
        href: "https://checkout.perfectpay.com.br/pay/PPU38CQ1PT3?upsell=true",
...
export default function UpsellStep6() {
    ...
    return (
        <div className="flex flex-col min-h-screen items-center bg-[#FDFAEB] w-full">
            {/* Red header */}
